    ...
    ui(new Ui::fpjc)
{
    ...
    //ui->SLJ_LeftBehind_label->setVisible(false);
    //ui->SLJ_LeftFront_label->setVisible(false);
    //ui->SLJ_Left_Roller_Speed_label->setVisible(false);
    ...
    ui->leftFpButton->setVisible(false);
    ui->rightFpButton->setVisible(false);
    ui->leftLdButton->setEnabled(false);
    ui->rightLdButton->setEnabled(false);
    ui->leftLdButton->setVisible(true);
    ui->rightLdButton->setVisible(true);
    ...
    QStringList hisItems = {"左履带行走压力", "右履带行走压力","左履带行走转速",
                            "右履带行走转速"};
...
void Fpjc::updateWatch()
{
    ...
    DeviceNode deviceNode = Global::getYhcNodeInfoByName("SLJ_Gate_OT_Rotation_Pressure");
    float address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_Gate_OT_Rotation_Pressure value: " << Global::currentYhcDataMap.value(address);
    float lrp = Global::currentYhcDataMap.value(address).toFloat();

    deviceNode = Global::getYhcNodeInfoByName("SLJ_Left_Roller_Speed");
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_Left_Roller_Speed value: " << Global::currentYhcDataMap.value(address);
    ushort lrs = Global::currentYhcDataMap.value(address).toUShort();
    ushort lrs = 0;

    ui->fpjWatchsWidget->updateLeftTopPlate(lrp, lrs);

    deviceNode = Global::getYhcNodeInfoByName("SLJ_SP_OT_Pressure");
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_SP_OT_Pressure value: " << Global::currentYhcDataMap.value(address);
    float rrp = Global::currentYhcDataMap.value(address).toFloat();

    deviceNode = Global::getYhcNodeInfoByName("SLJ_Right_Roller_Speed");
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_Right_Roller_Speed value: " << Global::currentYhcDataMap.value(address);
    ushort rrs = Global::currentYhcDataMap.value(address).toUShort();
    ushort rrs = 0;

    ui->fpjWatchsWidget->updateRightTopPlate(rrp, rrs);

    deviceNode = Global::getYhcNodeInfoByName("SLJ_Left_Walking_Pressure");
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_Left_Walking_Pressure value: " << Global::currentYhcDataMap.value(address);
    float lwp = Global::currentYhcDataMap.value(address).toFloat();

    deviceNode = Global::getYhcNodeInfoByName("SLJ_Left_Servo_Pulse");
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_Left_Servo_Pulse value: " << Global::currentYhcDataMap.value(address);
    uint lsp = Global::currentYhcDataMap.value(address).toUInt();

    ui->fpjWatchsWidget->updateLeftBottomPlate(lwp, lsp);

    deviceNode = Global::getYhcNodeInfoByName("SLJ_Right_Walking_Pressure");
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_Right_Walking_Pressure value: " << Global::currentYhcDataMap.value(address);
    float rwp = Global::currentYhcDataMap.value(address).toFloat();

    deviceNode = Global::getYhcNodeInfoByName("SLJ_Right_Servo_Pulse");
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_Right_Servo_Pulse value: " << Global::currentYhcDataMap.value(address);
    uint rsp = Global::currentYhcDataMap.value(address).toUInt();

    ui->fpjWatchsWidget->updateRightBottomPlate(rwp, rsp);

    deviceNode = Global::getYhcNodeInfoByName("SLJ_HS_1_Tempture");
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_HS_1_Tempture value: " << Global::currentYhcDataMap.value(address);
    float ht1 = Global::currentYhcDataMap.value(address).toFloat();

    deviceNode = Global::getYhcNodeInfoByName("SLJ_HS_1_Oil_Level");
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_HS_1_Oil_Level value: " << Global::currentYhcDataMap.value(address);
    float hl1 = Global::currentYhcDataMap.value(address).toUShort();

    ui->fpjWatchsWidget->updateLeftCenterPlate(ht1, hl1);

    deviceNode = Global::getYhcNodeInfoByName("SLJ_HS_2_Tempture");
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_HS_2_Tempture value: " << Global::currentYhcDataMap.value(address);
    float ht2 = Global::currentYhcDataMap.value(address).toFloat();

    deviceNode = Global::getYhcNodeInfoByName("SLJ_HS_2_Oil_Level");
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_HS_2_Oil_Level value: " << Global::currentYhcDataMap.value(address);
    ...
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_LeftFront value: " << Global::currentYhcDataMap.value(address);
    ...
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_RightFront value: " << Global::currentYhcDataMap.value(address);
    ...
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_LeftBehind value: " << Global::currentYhcDataMap.value(address);
    ...
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_RightBehind value: " << Global::currentYhcDataMap.value(address);
    ui->SLJ_RightBehind_label->setText(Global::currentYhcDataMap.value(address));

    deviceNode = Global::getYhcNodeInfoByName("SLJ_RightTop");
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_RightTop value: " << Global::currentYhcDataMap.value(address);
    ui->SLJ_RightFront_label->setText(Global::currentYhcDataMap.value(address));

    deviceNode = Global::getYhcNodeInfoByName("SLJ_RightMiddle");
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_RightMiddle value: " << Global::currentYhcDataMap.value(address);
    ui->SLJ_RightBehind_label->setText(Global::currentYhcDataMap.value(address));

    deviceNode = Global::getYhcNodeInfoByName("SLJ_RightBottom");
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_RightBottom value: " << Global::currentYhcDataMap.value(address);
    ui->SLJ_Right_Roller_Speed_label->setText(Global::currentYhcDataMap.value(address));

    deviceNode = Global::getYhcNodeInfoByName("SLJ_Left_Track_Encoder_Cycle_Num");
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_Left_Track_Encoder_Cycle_Num value: " << Global::currentYhcDataMap.value(address);
    ui->speedLabel->setText(Global::currentYhcDataMap.value(address));

    deviceNode = Global::getYhcNodeInfoByName("SLJ_Right_Track_Encoder_Cycle_Num");
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_Right_Track_Encoder_Cycle_Num value: " << Global::currentYhcDataMap.value(address);
...
void Fpjc::updateChart()
{
    ...
    DeviceGroupInfo info = Global::getYhcDeviceGroupInfo(deviceIndex);
    /*DeviceNode deviceNode = Global::getYhcNodeInfoByName("SLJ_Left_Roller_Pressure");
    float address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_Left_Roller_Pressure value: " << Global::currentYhcDataMap.value(address);
    ...
    strcpy(data.name, QString("SLJ_Left_Roller_Pressure").toLatin1().data());
    strcpy(data.value, Global::currentYhcDataMap.value(address).toLatin1().data());
    emit histDataReady(data);

    float lrp = 0;

    DeviceNode deviceNode = Global::getYhcNodeInfoByName("SLJ_Left_Roller_Speed");
    float address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_Left_Roller_Speed value: " << Global::currentYhcDataMap.value(address);
    int index = Global::convertAddressToIndex(address, deviceNode.DataType);
    ushort lrs = Global::currentYhcDataMap.value(address).toUShort();
    ...
    data.index = 0;
    strcpy(data.insertTime, QString::number(stime).toLatin1().data());
    strcpy(data.name, QString("SLJ_Left_Roller_Speed").toLatin1().data());
    strcpy(data.value, Global::currentYhcDataMap.value(address).toLatin1().data());
    emit histDataReady(data);
    ...
    deviceNode = Global::getYhcNodeInfoByName("SLJ_Right_Roller_Pressure");
    address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_Right_Roller_Pressure value: " << Global::currentYhcDataMap.value(address);
    ...
    data.index = 0;
    strcpy(data.insertTime, QString::number(stime).toLatin1().data());
    strcpy(data.name, QString("SLJ_Right_Roller_Pressure").toLatin1().data());
    strcpy(data.value, Global::currentYhcDataMap.value(address).toLatin1().data());
    emit histDataReady(data);
    ...
    data.index = 0;
    strcpy(data.insertTime, QString::number(stime).toLatin1().data());
    strcpy(data.name, QString("SLJ_Right_Roller_Speed").toLatin1().data());
    strcpy(data.value, Global::currentYhcDataMap.value(address).toLatin1().data());
    emit histDataReady(data);
    ...
    /*DeviceNode deviceNode = Global::getYhcNodeInfoByName("SLJ_Left_Walking_Pressure");
    float address = deviceNode.Offset + (info.offset + deviceIndex - info.startIndex) * Global::getLengthByDataType(deviceNode.DataType);
    qDebug() << "SLJ_Left_Walking_Pressure value: " << Global::currentYhcDataMap.value(address);
    int index = Global::convertAddressToIndex(address, deviceNode.DataType);
    float lwp = Global::currentYhcDataMap.value(address).toFloat();
    ...
    data.index = 0;
    strcpy(data.insertTime, QString::number(stime).toLatin1().data());
    strcpy(data.name, QString("SLJ_Left_Walking_Pressure").toLatin1().data());
    strcpy(data.value, Global::currentYhcDataMap.value(address).toLatin1().data());
    emit histDataReady(data);
    ...
    data.index = 0;
    strcpy(data.insertTime, QString::number(stime).toLatin1().data());
    strcpy(data.name, QString("SLJ_Left_Servo_Pulse").toLatin1().data());
    strcpy(data.value, Global::currentYhcDataMap.value(address).toLatin1().data());
    emit histDataReady(data);
    ...
    data.index = 0;
    strcpy(data.insertTime, QString::number(stime).toLatin1().data());
    strcpy(data.name, QString("SLJ_Right_Walking_Pressure").toLatin1().data());
    strcpy(data.value, Global::currentYhcDataMap.value(address).toLatin1().data());
    emit histDataReady(data);
    ...
    data.index = 0;
    strcpy(data.insertTime, QString::number(stime).toLatin1().data());
    strcpy(data.name, QString("SLJ_Right_Servo_Pulse").toLatin1().data());
    strcpy(data.value, Global::currentYhcDataMap.value(address).toLatin1().data());
    emit histDataReady(data);
