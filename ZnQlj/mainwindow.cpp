    ...
    ui(new Ui::MainWindow)
{
    ...
    QString fpjcStyleStr="QPushButton#fpjcButton{background: transparent; background-image: url(:/pic/料1_dark.png);}"
                         "QPushButton#fpjcButton:hover{background: transparent; background-image: url(:/pic/料1_light.png);}"
                         "QPushButton#fpjcButton:pressed{background: transparent; background-image: url(:/pic/料1_light.png);}";
