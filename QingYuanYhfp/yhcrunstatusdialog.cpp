...
void YhcRunStatusDialog::showStatus()
{
    ...
    run = Global::getYhcRunctrValueByName(_deviceIndex, "YHC_KP_FPJ_CONTROL", Global::currentYhcDataMap);
    if(run)
    {
        ui->YHC_KP_FPJ_CONTROL_label->setStyleSheet("background-image: url(:/pic/wheel_run.png)");
    }
    else
    {
        ui->YHC_KP_FPJ_CONTROL_label->setStyleSheet("background-image: url(:/pic/wheel_stop.png)");
    }
    ...
    if(coro || inve)
    {
        ui->CT_STATE_label->setStyleSheet("background-image: url(:/pic/wheel_run.png)");
    }
    else
    {
        ui->CT_STATE_label->setStyleSheet("background-image: url(:/pic/wheel_stop.png)");
    }
