...
private:
    ...
    bool lsoo1, lsoo2, lsoo3,ls_level_fault,fan_fault;
    bool wnlx_1_fault,wnlx_2_fault,fhlx_1_fault,fhlx_2_fault,fhlx_3_fault,fhlx_4_fault;
    bool dv_1_fault,dv_2_fault,fllx_1_fault,fllx_2_fault,fllx_3_fault,fllx_4_fault;
