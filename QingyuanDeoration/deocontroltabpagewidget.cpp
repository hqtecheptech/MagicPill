    ...
    ui(new Ui::DeoControlTabPageWidget)
{
    ...
    ui->fan_frame_3_layout->addWidget(fan3);
...
void DeoControlTabPageWidget::parseRunCtrData(QMap<float,QString> dataMap)
{
    ...
    if(isLevelLow)
    {
        ...
        ui->water_tank_1_level_state_label->setPixmap(waterLevelLowShortReverseBgImg);
    ...
    if(isLevelLow)
    {
        ...
        ui->water_tank_1_level_state_label->setPixmap(waterLevelNormalShortReverseBgImg);
