...
private slots:
    ...
    void on_deoValuesButton_clicked();
...
private:
    ...
    TankAirValve *tankAirValve13;
    TankAirValve *tankAirValve14;
    TankAirValve *tankAirValve15;
    TankAirValve *tankAirValve16;
    TankAirValve *tankAirValve17;
    TankAirValve *tankAirValve18;

    TankAirValve *fjValve1;
    TankAirValve *fjValve2;
    TankAirValve *fjValve3;
    TankAirValve *fjValve4;
    TankAirValve *fjValve5;
    TankAirValve *fjValve6;
    TankAirValve *fjValve7;
    TankAirValve *fjValve8;

    SingleDeodorationFan *fan1;
    SingleDeodorationFan *fan2;
    SingleDeodorationFan *fan3;
    ...
    QPixmap waterLevelLowReverseBgImg;
    QPixmap waterLevelNormalReverseBgImg;
    QPixmap waterLevelLowShortBgImg;
    QPixmap waterLevelNormalShortBgImg;
    QPixmap waterLevelLowShortReverseBgImg;
    QPixmap waterLevelNormalShortReverseBgImg;
    bool blowing = false;
    QTimer *blowTimer;
    void parseDeodorationData(QMap<float,QString> dataMap);
    void parseRunCtrData(QMap<float,QString> dataMap);
    QMessageBox msgBox;
    ControllerStatusDialog* csDlg;
