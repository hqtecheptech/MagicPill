    ...
    ui(new Ui::DeoControlTabPageWidget)
{
    ...
    ui->label_42->setStyleSheet("QLabel {font: bold 15px;}");
    ui->aivLabel->setStyleSheet("QLabel {font: 15px;}");
    ui->label_45->setStyleSheet("QLabel {font: bold 15px;}");
    ui->label_190->setStyleSheet("QLabel {font: bold 11px;}");
    ui->label_71->setStyleSheet("QLabel {font: bold 11px;}");
    ui->label_36->setStyleSheet("QLabel {font: bold 11px;}");
    ui->label_46->setStyleSheet("QLabel {font: bold 11px;}");
    ui->label_157->setStyleSheet("QLabel {font: bold 10px;}");
    ui->label_158->setStyleSheet("QLabel {font: bold 10px;}");
    ui->label_159->setStyleSheet("QLabel {font: bold 11px;}");
    ui->label_160->setStyleSheet("QLabel {font: bold 10px;}");
    ui->label_162->setStyleSheet("QLabel {font: bold 10px;}");
    ui->label_163->setStyleSheet("QLabel {font: bold 10px;}");
    ui->label_164->setStyleSheet("QLabel {font: bold 11px;}");
    ui->label_165->setStyleSheet("QLabel {font: bold 10px;}");

    ui->waterTankLevelValueLabel_1->setStyleSheet("QLabel {font: 11px;}");
    ui->waterTankLevelValueLabel_2->setStyleSheet("QLabel {font: 11px;}");
    ui->waterTankTemptureLabel_1->setStyleSheet("QLabel {font: 11px;}");
    ui->waterTankTemptureLabel_2->setStyleSheet("QLabel {font: 11px;}");
    ui->waterTankPhLabel_1->setStyleSheet("QLabel {font: 11px;}");
    ui->waterTankPhLabel_2->setStyleSheet("QLabel {font: 11px;}");

    ui->manualRunButton->setStyleSheet("QPushButton {font: bold 10px;}");
    ui->deoValuesButton->setStyleSheet("QPushButton {font: bold 10px;}");
    ...
    csDlg = new ControllerStatusDialog(this);
}
...
void DeoControlTabPageWidget::dispatchDeoData(QSet<int> changedDeviceIndex, QMap<float, QString> dataMap)
{
    ...
    for(uint i=0; i < valueNumber; i++)
    {
        ...
        DeviceNode deviceNode = Global::getDeoNodeInfoByRunctrAddress(dictAddress);
...
void DeoControlTabPageWidget::parseRunCtrData(QMap<float,QString> dataMap)
{
    ...
    bool isLevelLow = Global::getDeoRunctrValueByName(ui->deviceIndexComboBox->currentIndex(),"Tank_1_Level_Low_Signal",dataMap);
    if(isLevelLow)
    {
        ui->waterTankLevelStateLabel_1->setText(QStringLiteral("液位低"));
        ui->water_tank_level_state_label_1->setPixmap(waterLevelLowShortBgImg);
        ui->water_tank_level_state_label_2->setPixmap(waterLevelLowShortBgImg);
        ui->waterTankLevelStateLabel_1->setStyleSheet("background-color: rgb(255, 255, 0)");
    }

    isLevelLow = Global::getDeoRunctrValueByName(ui->deviceIndexComboBox->currentIndex(),"Tank_1_Level_Middle_Signal",dataMap);
    if(isLevelLow)
    {
        ui->waterTankLevelStateLabel_1->setText(QStringLiteral("液位中"));
        ui->water_tank_level_state_label_1->setPixmap(waterLevelNormalShortBgImg);
        ui->water_tank_level_state_label_2->setPixmap(waterLevelNormalShortBgImg);
        ui->waterTankLevelStateLabel_1->setStyleSheet("background-color: rgb(0, 170, 0)");
    }

    isLevelLow = Global::getDeoRunctrValueByName(ui->deviceIndexComboBox->currentIndex(),"Tank_1_Level_High_Signal",dataMap);
    if(isLevelLow)
    {
    ...
    if(isLevelLow)
    {
        ...
        ui->water_tank_level_state_label_3->setPixmap(waterLevelLowShortBgImg);
        ui->water_tank_level_state_label_4->setPixmap(waterLevelLowShortBgImg);
    ...
    if(isLevelLow)
    {
        ...
        ui->water_tank_level_state_label_3->setPixmap(waterLevelNormalShortBgImg);
        ui->water_tank_level_state_label_4->setPixmap(waterLevelNormalShortBgImg);
...
void DeoControlTabPageWidget::on_deoValuesButton_clicked()
{
    csDlg->show();
}
