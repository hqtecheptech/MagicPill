    ...
    ui(new Ui::LoginDialog)
{
    ...
    ui->userNameLineEdit->setStyleSheet("QLineEdit {font: 11px;}");
    ui->pwdLineEdit->setStyleSheet("QLineEdit {font: 11px;}");
    ui->loginButton->setStyleSheet("QPushButton {font: 11px;}");
    ui->logoutButton->setStyleSheet("QPushButton {font: 11px;}");
    ui->promptLabel->setStyleSheet("QLabel {font: 11px;}");
