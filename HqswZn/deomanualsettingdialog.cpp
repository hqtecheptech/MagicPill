...
void DeoManualSettingDialog::parseDeoRunCtrData(QMap<float, QString> dataMap)
{
    ...
    pump_pl_3_mode = Global::getDeoRunctrValueByName(deviceIndex,"Pump_PL_3_Auto",dataMap);
    if(!pump_pl_3_mode)
    {
        ui->switchPumpPlModePushButton_3->setIcon(QIcon(fanAutoControlBg));
    }
    else
    {
        ui->switchPumpPlModePushButton_3->setIcon(QIcon(fanManualControlBg));
    }
    ...
    fan_1_started = Global::getDeoRunctrValueByName(deviceIndex,"Fan_1_Run_Signal",dataMap);
    if(fan_1_started)
    {
    ...
    pump_pl_1_started = Global::getDeoRunctrValueByName(deviceIndex,"Pump_PL_1_Run_Signal",dataMap);
    ...
    pump_pl_2_started = Global::getDeoRunctrValueByName(deviceIndex,"Pump_PL_2_Run_Signal",dataMap);
    ...
    pump_pl_3_started = Global::getDeoRunctrValueByName(deviceIndex,"Pump_PL_3_Run_Signal",dataMap);
    ...
    heater_1_started = Global::getDeoRunctrValueByName(deviceIndex,"Heater_1_Run_Signal",dataMap);
    if(heater_1_started)
    {
    ...
    heater_1_mode = Global::getDeoRunctrValueByName(deviceIndex,"Heater_1_Auto",dataMap);
    if(!heater_1_mode)
    {
        ui->switchFirstHeaterPushButton->setIcon(QIcon(fanAutoControlBg));
    }
    else
    {
        ui->switchFirstHeaterPushButton->setIcon(QIcon(fanManualControlBg));
    }
    ...
    valve_bw_1_started = Global::getDeoRunctrValueByName(deviceIndex,"ValveBW_1_Run_Signal",dataMap);
...
void DeoManualSettingDialog::on_switchFirstHeaterPushButton_clicked()
{
    User *user = Identity::getInstance()->getUser();
    if(user != Q_NULLPTR)
    {
        ...
        ushort offset = Global::getDeodorationNodeInfoByName("Heater_1_Auto").Offset / 8;
        ushort index = Global::getDeodorationNodeInfoByName("Heater_1_Auto").Offset % 8;
...
void DeoManualSettingDialog::on_switchPumpPlModePushButton_3_clicked()
{
    User *user = Identity::getInstance()->getUser();
    if(user != Q_NULLPTR)
    {
        ...
        ushort offset = Global::getDeodorationNodeInfoByName("Pump_PL_3_Auto").Offset / 8;
        ushort index = Global::getDeodorationNodeInfoByName("Pump_PL_3_Auto").Offset % 8;
