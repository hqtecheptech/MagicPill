    ...
    ui(new Ui::FerStepForm)
{
    ...
    ui->max_time_text_edit->setVisible(false);
    ui->min_time_text_edit->setVisible(false);
    ui->def_frq_text_edit->setVisible(false);
    ui->step_tmp_text_edit->setVisible(false);
    ui->expect_tmp_text_edit->setVisible(false);
    ...
    ui->label->setStyleSheet("QLabel {font: 30px;}");
    ui->label_11->setStyleSheet("QLabel {font: bold 30px;}");
    ui->label_4->setStyleSheet("QLabel {font: 25px;}");
    ui->label_5->setStyleSheet("QLabel {font: 25px;}");
    ui->label_6->setStyleSheet("QLabel {font: 25px;}");
    ui->label_7->setStyleSheet("QLabel {font: 25px;}");
    ui->label_10->setStyleSheet("QLabel {font: 25px;}");
    ui->label_12->setStyleSheet("QLabel {font: 25px;}");

    ui->plan_num_label->setStyleSheet("QLabel {font: bold 25px;}");
    ui->air_mode_comboBox->setStyleSheet("QComboBox {font: bold 23px;}");
    ui->def_ae_text_edit->setStyleSheet("QTextEdit {font: 25px;}");
    ui->def_sta_text_edit->setStyleSheet("QTextEdit {font: 25px;}");
    ui->def_frq_text_edit->setStyleSheet("QTextEdit {font: 25px;}");

    ui->add_case_push_button->setStyleSheet("QPushButton {font: bold 30px;}");
    ui->reduce_case_push_button->setStyleSheet("QPushButton {font: bold 30px;}");
