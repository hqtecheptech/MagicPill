    ...
    ui(new Ui::CustomFerSettingDialog)
{
    ...
    ui->label1->setStyleSheet("QLabel {font: 11px;}");
    ui->label2->setStyleSheet("QLabel {font: 11px;}");
    ui->label_2->setStyleSheet("QLabel {font: 11px;}");
    ui->aerationSpaceLineEdit->setStyleSheet("QLineEdit {font: 11px;}");
    ui->aerationTimeLineEdit->setStyleSheet("QLineEdit {font: 11px;}");
    ui->customFerButton->setStyleSheet("QPushButton {font: 11px;}");
    ui->customFerButton_2->setStyleSheet("QPushButton {font: 11px;}");
    ui->endCustomFerButton->setStyleSheet("QPushButton {font: 11px;}");
...
void CustomFerSettingDialog::on_customFerButton_pressed()
{
    ...
    if(user != Q_NULLPTR)
    {
        ...
        //Length of uint address and value, plus length of scrc.
        bpack.bDataLength = 2;
        bpack.bStreamLength += (2+4)*2 + 4;
