    ...
    ui(new Ui::RenhuaiNew)
{
    ...
    ui->label->setStyleSheet("QLabel {font: 14px;}");
    ui->label_2->setStyleSheet("QLabel {color:white;font: bold 35px;}");
    ui->label_3->setStyleSheet("QLabel {color:white;font: bold 15px;background: transparent;}");
    ui->label_4->setStyleSheet("QLabel {color:white;font: bold 15px;background: transparent;}");
    ui->date_label->setStyleSheet("QLabel {color:white;font: bold 15px;background: transparent;}");
    ui->time_label->setStyleSheet("QLabel {color:white;font: bold 15px;background: transparent;}");
    ui->week_label->setStyleSheet("QLabel {color:white;font: bold 15px;background: transparent;}");
    ui->label_5->setStyleSheet("QLabel {color:white;font: bold 14px;background: transparent;}");
    ui->label_6->setStyleSheet("QLabel {color:white;font: bold 14px;background: transparent;}");
    ui->label_7->setStyleSheet("QLabel {color:white;font: bold 14px;background: transparent;}");
    ui->label_8->setStyleSheet("QLabel {color:white;font: bold 14px;background: transparent;}");
    ui->hostname_label->setStyleSheet("QLabel {color:white;font: bold 14px;background: transparent;}");
    ui->serverIP_label->setStyleSheet("QLabel {color:white;font: bold 14px;background: transparent;}");
    ui->systemstatus_label->setStyleSheet("QLabel {color:white;font: bold 14px;background: transparent;}");
    ui->uploadtime_label->setStyleSheet("QLabel {color:white;font: bold 14px;background: transparent;}");
...
void RenhuaiNew::updateFerData(QSet<int> changedDeviceSet, QMap<float,QString> dataMap)
{
    ...
    /*QString strValue = "";
    DeviceNode node = Global::getFermenationNodeInfoByName("FER_WT_R");
    for(int i=0; i<4; i++)
    {
        uint address = node.Offset + i * Global::getLengthByDataType(node.DataType);
        strValue.append(QString::number(i+1) + ": " + QString::number(dataMap[address].toFloat(), 'f', 2) + " ℃  ");
    }

    QString preStr = "温度值 ";
    ui->tab_banner_label->setText(preStr + strValue);
