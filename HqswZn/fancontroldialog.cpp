    ...
    ui(new Ui::FanControlDialog)
{
    ...
    ui->label_4->setStyleSheet("QLabel {font: 11px;}");
    ui->label_5->setStyleSheet("QLabel {font: 11px;}");
    ui->label_9->setStyleSheet("QLabel {font: 11px;}");
    ui->label_14->setStyleSheet("QLabel {font: 11px;}");
    ui->label_16->setStyleSheet("QLabel {font: 11px;}");
    ui->label_17->setStyleSheet("QLabel {font: 11px;}");
    ui->label_22->setStyleSheet("QLabel {font: 11px;}");
    ui->label_23->setStyleSheet("QLabel {font: 11px;}");
    ui->fanIndexComboBox->setStyleSheet("QComboBox {font: 20px;}");
    ui->fanIndexLabel->setStyleSheet("QLabel {font: 11px;}");
    ui->fanOpenPushButton->setStyleSheet("QPushButton {font: 11px;}");
    ui->fanStopPushButton->setStyleSheet("QPushButton {font: 11px;}");
    ui->closePushButton->setStyleSheet("QPushButton {font: 11px;}");
