    ...
    ui(new Ui::FerCaseForm)
{
    ...
    ui->seq_label->setStyleSheet("QLabel {font: bold 30px;}");
    ui->tem_range_label->setStyleSheet("QLabel {font: bold 30px;}");
    ui->ae_label->setStyleSheet("QLabel {font: 25px;}");
    ui->seq_label->setStyleSheet("QLabel {font: 25px;}");
    ui->freq_label->setStyleSheet("QLabel {font: 25px;}");
    ui->sta_label->setStyleSheet("QLabel {font: 25px;}");

    ui->low_tmp_text_edit->setStyleSheet("QTextEdit {font: 25px;}");
    ui->high_tmp_text_edit->setStyleSheet("QTextEdit {font: 25px;}");
    ui->ae_text_edit->setStyleSheet("QTextEdit {font: 25px;}");
    ui->sta_text_edit->setStyleSheet("QTextEdit {font: 25px;}");
    ui->freq_text_edit->setStyleSheet("QTextEdit {font: 25px;}");
