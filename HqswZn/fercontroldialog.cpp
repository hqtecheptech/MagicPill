    ...
    ui(new Ui::FerControlDialog)
{
    ...
    ui->highTemptureLabel->setVisible(false);
    ui->midTemptureLabel->setVisible(false);
    ui->weightTemptureLabel->setVisible(false);
    ui->envTemptureLabel->setVisible(false);
    ui->envhumidityLabel->setVisible(false);
    ...
    //ui->startFerButton->setVisible(false);
    ui->label_32->setVisible(false);
    ui->currentStepTimeLabel->setVisible(false);

    ui->label_19->setVisible(false);
    ui->label_20->setVisible(false);
    ui->label_21->setVisible(false);
    ui->runStepComboBox->setVisible(false);
    ui->changeStepButton->setVisible(false);
    ui->runStateStepLabel->setVisible(false);

    ui->tankIndexComboBox->setStyleSheet("QComboBox {font: 20px;}");
    ui->label->setStyleSheet("QLabel {font: 11px;}");
    ui->label_2->setStyleSheet("QLabel {font: 11px;}");
    ui->label_3->setStyleSheet("QLabel {font: 11px;}");
    ui->label_5->setStyleSheet("QLabel {font: 11px;}");
    ui->tankIndexLabel->setStyleSheet("QLabel {font: 11px;}");
    ui->ferStartTimeLabel->setStyleSheet("QLabel {font: 11px;}");
    ui->ferEndTimeLabel->setStyleSheet("QLabel {font: 11px;}");
    ui->ferTotalTimeLabel->setStyleSheet("QLabel {font: 11px;}");
    ui->label_22->setStyleSheet("QLabel {font: 11px;}");
    ui->label_23->setStyleSheet("QLabel {font: 11px;}");
    ui->label_24->setStyleSheet("QLabel {font: 11px;}");
    ui->label_25->setStyleSheet("QLabel {font: 11px;}");
    ui->label_27->setStyleSheet("QLabel {font: 11px;}");
    ui->label_28->setStyleSheet("QLabel {font: 11px;}");
    ui->label_29->setStyleSheet("QLabel {font: 11px;}");
    ui->label_30->setStyleSheet("QLabel {font: 11px;}");
    ui->label_31->setStyleSheet("QLabel {font: 11px;}");
    ui->ferStateLabel->setStyleSheet("QLabel {font: 11px;}");
    ui->aerationStateLabel->setStyleSheet("QLabel {font: 11px;}");
    ui->aerationTotalTimeLabel->setStyleSheet("QLabel {font: 11px;}");
    ui->stillTotalTimeLabel->setStyleSheet("QLabel {font: 11px;}");
    ui->handRunTimeValueLabel->setStyleSheet("QLabel {font: 11px;}");
    ui->handSpaceTimeValeLabel->setStyleSheet("QLabel {font: 11px;}");
    ui->startFerButton->setStyleSheet("QPushButton {font: 11px;}");
    ui->endFerButton->setStyleSheet("QPushButton {font: 11px;}");
    ui->customFerButton->setStyleSheet("QPushButton {font: 11px;}");
    ui->exitButton->setStyleSheet("QPushButton {font: 11px;}");
    ...
    {
        ui->tankIndexComboBox->addItem(QStringLiteral("%1#阶段").arg(QString::number(i+1)));
    }
