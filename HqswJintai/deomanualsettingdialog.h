...
private slots:
    ...
    void on_switchFirstHeaterPushButton_clicked();

    void on_switchBwValveModePushButton_1_clicked();

    void on_switchPumpPlModePushButton_3_clicked();
...
private:
    ...
    bool heater_1_started, heater_2_started, heater_1_mode;
    bool fanMode, fanSbMode, pump_1_mode, pump_2_mode, pump_1_sb_mode, pump_2_sb_mode;
    bool pump_pl_1_mode, pump_pl_2_mode, pump_pl_3_mode, pump_pl_1_sb_mode, pump_pl_2_sb_mode;
