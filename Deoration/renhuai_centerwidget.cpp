...
#include "ui_renhuai_centerwidget.h"
#include "ufftank.h"
...
RenHuai_CenterWidget::RenHuai_CenterWidget(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::RenHuai_CenterWidget)
{
    ui->setupUi(this);
...
RenHuai_CenterWidget::~RenHuai_CenterWidget()
{
...
void RenHuai_CenterWidget::timerEvent(QTimerEvent *event)
{
    read_tank_data();
}

void RenHuai_CenterWidget::showEvent(QShowEvent *event)
{
...
void RenHuai_CenterWidget::closeEvent(QCloseEvent *event)
{

}

void RenHuai_CenterWidget::showAllPlcData(QByteArray data)
{
    StreamPack bDevice;
...
void RenHuai_CenterWidget::parseFermentationData(QMap<float,QString> dataMap)
{
...
void RenHuai_CenterWidget::parseRunTimeData(QMap<float,QString> dataMap)
{
...
void RenHuai_CenterWidget::parseStepData(QMap<float,QString> dataMap)
{
...
void RenHuai_CenterWidget::parseRunCtrData(QMap<float,QString> dataMap)
{
...
void RenHuai_CenterWidget::showFermentationData(QByteArray data)
{
    StreamPack bDevice;
    memcpy(&bDevice,data,sizeof(bDevice));
...
void RenHuai_CenterWidget::showRunTimeData(QByteArray data)
{
    StreamPack bDevice;
    memcpy(&bDevice,data,sizeof(bDevice));
...
void RenHuai_CenterWidget::showStepData(QByteArray data)
{
    StreamPack bDevice;
    memcpy(&bDevice,data,sizeof(bDevice));
...
// /Todo
void RenHuai_CenterWidget::showRunCtrData(QByteArray data)
{
    StreamPack bDevice;
    memcpy(&bDevice,data,sizeof(bDevice));
...
void RenHuai_CenterWidget::requestFermentationData(StreamPack requestPack)
{
    getFerTcpClient->sendRequest(requestPack);
}

void RenHuai_CenterWidget::requestRunTimeData(StreamPack requestPack)
{
    getRunTimeTcpClient->sendRequest(requestPack);
}

void RenHuai_CenterWidget::requestStepData(StreamPack requestPack)
{
    getStepTcpClient->sendRequest(requestPack);
}

void RenHuai_CenterWidget::requestRunCtrData(StreamPack requestPack)
{
    getRunCtrTcpClient->sendRequest(requestPack);
}

void RenHuai_CenterWidget::localServerConnected(bool isConnected)
{
...
void RenHuai_CenterWidget::read_tank_data()
{
    //qDebug() << "Read_tank_data ***************************************************************** : " << readNumber++;
    getServerConnectStateTcpClient->sendTestConnectRequest();
}

QVector<UFFTank *> RenHuai_CenterWidget::getTanks() const
{
    return tanks;
}
...
void RenHuai_CenterWidget::on_fanControlButton_clicked()
{
...
void RenHuai_CenterWidget::on_ferControlButton_clicked()
{
    if(isServerConnected)
    {
...
void RenHuai_CenterWidget::on_HistoryQueryButton_clicked()
{
    if(isServerConnected)
    {
        historyDialog->show();
...
void RenHuai_CenterWidget::on_ReportButton_clicked()
{
    if(isServerConnected)
    {
        reportDialog->show();
...
void RenHuai_CenterWidget::on_toolButton_2_clicked()
{
    if(isServerConnected)
    {
        loginDialog->show();
...
void RenHuai_CenterWidget::on_realTimeChartButton_clicked()
{
    if(isServerConnected)
    {
...
void RenHuai_CenterWidget::on_exitButton_clicked()
{
    QApplication::quit();
}

void RenHuai_CenterWidget::on_SettingButton_clicked()
{
    if(isServerConnected)
    {
        settingDialog->show();
...
void RenHuai_CenterWidget::on_AlertQueryButton_clicked()
{
    alertQueryDialog->show();
}

void RenHuai_CenterWidget::on_deoControlButton_clicked()
{
    deoControlDialog->show();
}


void RenHuai_CenterWidget::on_testPushButton_clicked()
{
    testDlg->show();
}
